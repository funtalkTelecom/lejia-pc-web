		  ...
		  <el-table-column	prop="status"	align="center"	label="状态">
			<template slot-scope="scope">
				<el-button	:type="scope.row.status ? 'success' : 'danger'" size="mini"
				        @click="changeStatus(scope.row)"  plain>
		...
		data() {
			return {
				...
				tableData: [{
					id:1,
					username:"乐家",
					avatar:"https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1255236643,3901680688&fm=15&gp=0.jpg",
					user_level_id:1,
					user_level:{
						id:1,
						name:"普通会员"
					},
					create_time:"2020-08-10 12:10:10",
					update_time:"2020-08-11 12:10:10",
					status:1
				}],
				createModel:false,
				editIndex:-1,
				...
				user_level:[{id:1,name:"普通会员"},{id:2,name:"高级会员"}]
			}
		},
		methods: {
			getListResult(e){
