<template>
	<div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0!important;">
		<button-search ref="buttonSearch" class="pt-3" placeholder="要搜索的商品名称" 
		               @search="searchEvent" :showSuperSearch="false">
		</button-search>
		...
		<el-table border class="mt-3" :data="tableData"   style="width: 100%">
		  ...
		  <el-table-column type="expand">
			<template slot-scope="scope">
			  <div class="media">
			    <img class="mr-3" :src="scope.row.avatar" alt="Generic placeholder image" style="height: 70px;width: 70px;border-radius: 100%;">
			    <div class="media-body">
			      <h6 class="mt-0 d-flex">
					  {{scope.row.username}} <small>{{scope.row.reviewtime}}</small>
		  ...
		  <el-table-column	label="商品"	width="380">
			<template slot-scope="scope">
				<div class="media">
				  <img class="mr-3" style="width: 60px;height: 60px;"  :src="scope.row.goodsitem.cover">
				  <div class="media-body">
					<p class="mt-0">{{scope.row.goodsitem.title}}</p>
				  </div>
				</div>
			</template>
		  </el-table-column>
			...
			return {
				...
				tableData:[
							   {id:1,
								...
								reviewtime:"2020-08-10 12:10:10",
